  ...
  return (
    ...
    >
      ...
      >
        {isLoggedIn && (
          <li onClick={handleMouseLeave}>
            <Link to="/profile" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
              My Account
            </Link>
          </li>
        )}
        <li onClick={handleMouseLeave}>
          <Link to="/restaurants" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
            All Restaurants
          </Link>
        </li>
        <li onClick={handleMouseLeave}>
          <Link to="/dine-in" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
            Dine in Restaurants
          </Link>
        </li>
        <li onClick={handleMouseLeave}>
          <Link to="/delivery-support" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
            Delivery Support
          </Link>
        </li>
        <li onClick={handleMouseLeave}>
          <Link to="/contact-us" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
            Contact Us
          </Link>
        </li>
        <li onClick={handleMouseLeave}>
          <Link to="/terms" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
            Terms of Use
          </Link>
        </li>
        <li onClick={handleMouseLeave}>
          <Link to="/privacy" className="block px-4 py-1 text-gray-800 hover:bg-gray-100">
            Privacy Policy
          </Link>
        </li>
      </Menu>
